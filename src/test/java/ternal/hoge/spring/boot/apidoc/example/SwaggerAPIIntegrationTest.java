package ternal.hoge.spring.boot.apidoc.example;

import ternal.hoge.spring.boot.apidoc.example.api.ApiConfiguration;
import ternal.hoge.spring.boot.apidoc.example.hoge.UserRepository;
